      ...
      <div className="container max-w-5xl mx-auto px-4 flex flex-col flex-grow relative z-10">
        ...
        <header className="flex flex-col items-center mb-4 md:mb-6">
          <div className="flex items-center gap-3 mb-4">
            <h1 className={`text-5xl text-center font-bold ${doto.className}`}>
        ...
        <footer className="mt-auto pt-8 pb-8 text-gray-500 dark:text-gray-400 text-sm flex flex-col">
          <div className="flex items-center justify-between">
            <p className="flex items-center py-4 justify-center gap-3">
              Ray Fernando
              <a
            ...
            {/* Theme Toggle Button */}
            <div className="absolute bottom-2 right-2 md:bottom-8 md:right-0">
              <ThemeToggle />
            </div>
          </div>
        </footer>
